...
class KnowledgeGraph(nn.Module):
    ...
    def get_global_h_t(self, seeds, pre_langs, all_entity2kgs, all_entity_global_index):
        ...
        self.h_train_global = self._get_global_index(self.h_train, all_entity_global_index) # global id
        ...
        self.entity_global_index = all_entity_global_index[self.lang] # global id in current KG
    ...
    def _get_entity_global_index(self, seeds, pre_langs, all_entity2kgs, all_entity_global_index):
        ...
        if len(all_entity2kgs) == 0:
            for i in range(self.num_entities):
                all_entity_global_index[self.lang].append(i) # entity in the KG
